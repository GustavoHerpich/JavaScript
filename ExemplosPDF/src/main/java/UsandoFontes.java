...
public class UsandoFontes {
    public static void main(String[] args) {
        Font blueFont = FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL,
                new CMYKColor(255, 0, 0, 0));
        Font redFont = FontFactory.getFont(FontFactory.COURIER, 12, Font.BOLD,
        ...
        try {
            ...
            Paragraph paragraphOne = new Paragraph("Some colored paragraph text",
                    redFont);
